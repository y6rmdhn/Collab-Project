  ...
  return (
    <section className="w-full">
      <div className="flex flex-col items-center justify-center pt-10 px-[24px]">
        ...
        <p className="text-base text-center mt-2 mb-2">
          Featuring Air Jordan 3 'Black Cement' & more.
        </p>
      ...
      <div className="w-full mt-10">
        <img
          src="https://static.nike.com/a/images/f_auto/dpr_2.0,cs_srgb/h_542,c_limit/e52883f4-6407-4355-9414-baeb1c7d5a03/nike-just-do-it.jpg"
          alt=""
        />
      </div>
      ...
      <div className="flex flex-col">
        <div className="mt-20">
          <img
            src="https://static.nike.com/a/images/f_auto/dpr_2.0,cs_srgb/w_320,c_limit/82524845-2637-4b3c-a7cb-67a416108197/nike-just-do-it.png"
            alt=""
          />
        </div>
